...
def sprint_chunk_document():
    ...
    split_prompt = (
        ...
        f"2. For each day, provide 3 to 4 very concise, short bullet points summarizing the key concepts. Do NOT write long paragraphs. Keep each point under 1-2 sentences.\n"
        ...
        f"{{\n"
        f"  \"day1\": [\"Short bullet point 1 for Day 1\", \"Short bullet point 2 for Day 1\", \"Short bullet point 3 for Day 1\"],\n"
        f"  \"day2\": [\"Short bullet point 1 for Day 2\", \"Short bullet point 2 for Day 2\", \"Short bullet point 3 for Day 2\"],\n"
        f"  \"day3\": [\"Short bullet point 1 for Day 3\", \"Short bullet point 2 for Day 3\", \"Short bullet point 3 for Day 3\"],\n"
        f"  \"day4\": [\"Short bullet point 1 for Day 4\", \"Short bullet point 2 for Day 4\", \"Short bullet point 3 for Day 4\"]\n"
        f"}}"
    )
